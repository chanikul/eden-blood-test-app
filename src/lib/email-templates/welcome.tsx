...
export function WelcomeEmail({ name, email, tempPassword, orderId, testName }: { name: string; email: string; tempPassword: string; orderId?: string; testName?: string }) {
    ...
    <Html>
      ...
      <Body style={styles.body}>
        <Container style={styles.container}>
          ...
          <Text style={styles.notice}>For security reasons, you will be required to change your password when you first log in.</Text>

          <Hr style={styles.hr} />
          <Text style={styles.subheading}>Next Steps</Text>
          <ul style={styles.list}>
            <li>Login to your patient portal</li>
            <li>Set a new secure password (required on first login)</li>
...
// Note: The generateWelcomeEmail function is now implemented in welcome-wrapper.js
// This avoids webpack cache issues with dynamic imports in Next.js
...
const styles = {
  ...
  notice: { fontSize: '16px', lineHeight: '24px', marginBottom: '12px', color: '#e74c3c', fontWeight: '600' },
