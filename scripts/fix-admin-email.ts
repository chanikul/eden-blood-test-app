...
async function fixAdminEmail() {
  try {
    ...
    await prisma.$executeRaw`DELETE FROM "Admin" WHERE email = 'admin@edenclinic.co.uk' OR email = 'admin@edenclinic.co.uk'`;
    
    // Create new admin with the exact email from the screenshot
