...
- Name: Blood Test Order Form >> shows error message on API failure
- Location: C:\Users\chani\CascadeProjects\eden-clinic\tests\blood-test-order.spec.ts:137:7
...
Call log:
  - waiting for getByRole('combobox', { name: 'Select a Blood Test *' })
    ...
    at C:\Users\chani\CascadeProjects\eden-clinic\tests\blood-test-order.spec.ts:145:22
```
