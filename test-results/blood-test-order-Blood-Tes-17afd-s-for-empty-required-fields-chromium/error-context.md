...
- Name: Blood Test Order Form >> shows validation errors for empty required fields
- Location: C:\Users\chani\CascadeProjects\eden-clinic\tests\blood-test-order.spec.ts:49:7
...
Locator: getByTestId('testSlug-error')
Expected string: "Please select a blood test"
Received string: "Required"
Call log:
  - expect.toHaveText with timeout 5000ms
  - waiting for getByTestId('testSlug-error')
    9 × locator resolved to <span id="radix-«rc»" data-testid="testSlug-error" class="mt-1 text-sm text-red-500">Required</span>
      - unexpected value "Required"

    at C:\Users\chani\CascadeProjects\eden-clinic\tests\blood-test-order.spec.ts:73:54
```
